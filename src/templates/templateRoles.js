    ...
    return (
      <React.Fragment>
        <article className="rolesPage">
          ...
          <ComponentVisualButton name="Estoy buscando contratar para un puesto o proyecto en nombre de una empresa" className="enterprise" buttonOnClick={evt => this.redirect('/auth', evt)} />
